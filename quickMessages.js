...
const elements = {
    ...
    emojiReactionBar: document.getElementById('emoji-reaction-bar'),
    emojiReactionList: document.getElementById('emoji-reaction-list'),
    ...
    bellTriggerBtn: document.getElementById('bell-trigger-btn'),
    
    autoplayModal: document.getElementById('autoplay-modal'),
    joinChatBtn: document.getElementById('join-chat-btn'),
    incomingRingOverlay: document.getElementById('incoming-ring-overlay'),
    incomingRingSender: document.getElementById('incoming-ring-sender'),
    ...
    mediaCaptionInput: document.getElementById('media-caption-input'),
    mediaPreviewCancel: document.getElementById('media-preview-cancel'),
    mediaPreviewSend: document.getElementById('media-preview-send'),
    
    messageInfoModal: document.getElementById('message-info-modal'),
    messageInfoList: document.getElementById('message-info-list'),
    messageInfoClose: document.getElementById('message-info-close')
};