...
-- =============================================
-- إضافة جدول الجرس (bell_ring)
-- شغّل السطور دي في SQL Editor في Supabase
-- =============================================

-- جدول الجرس
create table if not exists bell_ring (
...
-- صف أولي
insert into bell_ring (id, ringer, active, rung_at)
values (1, null, false, 0)
on conflict (id) do nothing;

-- Disable RLS
alter table bell_ring disable row level security;

-- تفعيل Realtime
alter publication supabase_realtime add table bell_ring;
